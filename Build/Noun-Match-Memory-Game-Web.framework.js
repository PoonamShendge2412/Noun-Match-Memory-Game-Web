...
var ASM_CONSTS = {
  3719216: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3719277: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3719341: function() {return Module.webglContextAttributes.powerPreference;},  
 3719399: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3719454: function($0) {performance.now = function() { return $0; };},  
 3719502: function($0) {performance.now = function() { return $0; };},  
 3719550: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _SocketCreate(url, protocols, openCallback, recvCallback, errorCallback, closeCallback)
  {
      ...
      socket.socket.onopen = function () {
          (function(a1) {  dynCall_vi.apply(null, [openCallback, a1]); })(instance);
      }
      socket.socket.onmessage = function (e) {
          if (e.data instanceof ArrayBuffer)
          {
              ...
              (function(a1, a2, a3) {  dynCall_viii.apply(null, [recvCallback, a1, a2, a3]); })(instance, ptr, b.byteLength);
              _free(ptr);
          }
      };
      socket.socket.onerror = function (e) {
          (function(a1, a2) {  dynCall_vii.apply(null, [errorCallback, a1, a2]); })(instance, e.code);
      }
      socket.socket.onclose = function (e) {
          if (e.code != 1000)
          {
              (function(a1, a2) {  dynCall_vii.apply(null, [closeCallback, a1, a2]); })(instance, e.code);
          }
      }
      return instance;
  }
